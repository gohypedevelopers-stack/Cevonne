...
export const CEVONNE_WORKFLOW_DIRECTORY: CevonneWorkflowDirectoryEntry[] = [
  ...
  },
  {
    ...
    purpose: "Tracks approved assets, human approval, and manual publish proof.",
    description: "G4-approved content stays in queue until media is attached, approval is recorded, and manual publish proof is saved.",
    status: "PENDING",
    lifecycleState: "PENDING",
    safetyNote: "Manual publishing only. No auto-publish.",
    routeNames: ["/api/cevonne/admin/approval-decision", "/api/cevonne/admin/manual-review"],
