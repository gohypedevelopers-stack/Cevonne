...
type SidebarInputProps = React.ComponentPropsWithoutRef<"input">
...
function SidebarContent({
  ...
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto group-data-[collapsible=icon]:overflow-hidden group-data-[collapsible=icon]:px-0",
        className
      )}
      {...props} />
  );
