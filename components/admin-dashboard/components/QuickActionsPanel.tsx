...
type QuickActionsPanelProps = {
    ...
    onRefresh?: () => void;
    stats?: QuickActionsPanelStats | null;
};
    ...
    const quickActions = [
        ...
        },
        {
            ...
            onClick: () => {
                ...
                setTimeout(() => {
                    const collectionsTab = document.querySelector<HTMLElement>('[value="collections"]');
        ...
        },
        {
            ...
            onClick: () => {
                document.getElementById("management")?.scrollIntoView({ behavior: "smooth" });
                setTimeout(() => {
                    const shadesTab = document.querySelector<HTMLElement>('[value="shades"]');
                    shadesTab?.click();
                }, 300);
            },
            variant: "secondary",
