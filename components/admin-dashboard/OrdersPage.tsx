...
export default function OrdersPage() {
  ...
  const load = async () => {
    ...
    try {
      ...
      const data = (await res.json()) as OrdersApiResponse | Order[];
      ...
      const nextSummary: OrderSummary =
        typeof (data as OrdersApiResponse)?.summary === "object" &&
        (data as OrdersApiResponse)?.summary !== null
          ? { ...computedSummary, ...((data as OrdersApiResponse).summary as Partial<OrderSummary>) }
          : computedSummary;
      setOrders(list);
