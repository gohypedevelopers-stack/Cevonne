...
const WORKFLOW_DETAIL_COPY: Record<CevonneWorkflowGroup, WorkflowDetailCopy> = {
  ...
  G5: {
    ...
    description: "Schedules approved posts after all checks are complete.",
    whatCameIn: "An approved post was ready to be scheduled.",
    whatWasChecked: "Approval status, timing, and posting readiness.",
    whatHappenedNext: "The workflow queued the post for scheduling after checks finished.",
    ...
    approvalPrompt: "Review the publishing request, then approve or reject it.",
  },
  G6: {
