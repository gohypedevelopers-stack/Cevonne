...
export async function POST(request: Request) {
  ...
  try {
    ...
    const payload = {
      created_by: "website_admin",
      source: "ADMIN",
      ...body,
    };
    const data = await callG2Webhook(env.n8nG2RegisterAccountPath, payload);
    ...
    return jsonResponse(
      {
        ...
        message: error instanceof Error ? error.message : "Unable to register account in G2.",
      },
      502,
    );
  }
