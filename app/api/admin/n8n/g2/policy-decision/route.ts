...
export async function POST(request: Request) {
  ...
  try {
    ...
    const payload = {
      decided_by: "website_admin",
      ...body,
    };
    const data = await callG2Webhook(env.n8nG2PolicyDecisionPath, payload);
    ...
    return jsonResponse(
      {
        ...
        message: error instanceof Error ? error.message : "Unable to record policy decision in G2.",
      },
      502,
    );
  }
