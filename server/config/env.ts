...
export const env = Object.freeze({
  ...
  r2AccountId: process.env.CLOUDFLARE_R2_ACCOUNT_ID || process.env.R2_ACCOUNT_ID || "",
  r2AccessKeyId: process.env.CLOUDFLARE_R2_ACCESS_KEY_ID || process.env.R2_ACCESS_KEY_ID || "",
  r2SecretAccessKey: process.env.CLOUDFLARE_R2_SECRET_ACCESS_KEY || process.env.R2_SECRET_ACCESS_KEY || "",
  r2BucketName: process.env.CLOUDFLARE_R2_BUCKET_NAME || process.env.R2_BUCKET_NAME || "",
  r2PublicUrl: normalizeOriginUrl(process.env.CLOUDFLARE_R2_PUBLIC_URL || process.env.R2_PUBLIC_BASE_URL || process.env.R2_PUBLIC_URL || ""),
  ...
  n8nG2GetAccountPath: process.env.N8N_G2_GET_ACCOUNT_PATH || "g2-get-account",
  ...
  n8nG2ListPolicyReviewsPath: process.env.N8N_G2_LIST_POLICY_REVIEWS_PATH || "g2-list-policy-reviews",
  n8nG2PolicyDecisionPath: process.env.N8N_G2_POLICY_DECISION_PATH || process.env.N8N_G2_POLICY_HUMAN_DECISION_PATH || "g2-policy-human-decision",
  n8nG2PolicyHumanDecisionPath: process.env.N8N_G2_POLICY_DECISION_PATH || process.env.N8N_G2_POLICY_HUMAN_DECISION_PATH || "g2-policy-human-decision",
  ...
  n8nG5ManualPublishResultPath: process.env.N8N_G5_MANUAL_PUBLISH_RESULT_PATH || "g5-manual-publish-result",
  n8nG6MessagingRouterPath: process.env.N8N_G6_MESSAGING_ROUTER_PATH || "g6-messaging-router",
  n8nG7OfferSafetyCheckPath: process.env.N8N_G7_OFFER_SAFETY_CHECK_PATH || "g7-offer-safety-check",
  n8nG7OfferSafetyCheckUrl: resolveWebhookUrl(process.env.N8N_G7_OFFER_SAFETY_CHECK_URL, process.env.N8N_G7_OFFER_SAFETY_CHECK_PATH || "g7-offer-safety-check"),
  n8nG7InventoryOfferSafetyPath: process.env.N8N_G7_INVENTORY_OFFER_SAFETY_PATH || "g7-inventory-offer-safety",
  n8nG7OfferProofPath: process.env.N8N_G7_OFFER_PROOF_PATH || "g7-offer-proof",
  n8nG7OfferProofUrl: resolveWebhookUrl(process.env.N8N_G7_OFFER_PROOF_URL, process.env.N8N_G7_OFFER_PROOF_PATH || "g7-offer-proof"),
  n8nG7OfferChangeEventPath: process.env.N8N_G7_OFFER_CHANGE_EVENT_PATH || "g7-offer-change-event",
  n8nG7OfferChangeEventUrl: resolveWebhookUrl(process.env.N8N_G7_OFFER_CHANGE_EVENT_URL, process.env.N8N_G7_OFFER_CHANGE_EVENT_PATH || "g7-offer-change-event"),
  n8nG7DashboardSummaryPath: process.env.N8N_G7_DASHBOARD_SUMMARY_PATH || "g7-dashboard-summary",
  n8nG7DashboardSummaryUrl: resolveWebhookUrl(process.env.N8N_G7_DASHBOARD_SUMMARY_URL, process.env.N8N_G7_DASHBOARD_SUMMARY_PATH || "g7-dashboard-summary"),
  n8nSupabaseUrl: process.env.N8N_SUPABASE_URL || process.env.SUPABASE_URL || "",
  n8nSupabaseServiceRoleKey: process.env.N8N_SUPABASE_SERVICE_ROLE_KEY || process.env.SUPABASE_SERVICE_ROLE_KEY || "",
  n8nG8UgcIntakePath: process.env.N8N_G8_UGC_INTAKE_PATH || "g8-v2-ugc-intake",
  n8nG8PermissionDecisionPath: process.env.N8N_G8_PERMISSION_DECISION_PATH || "g8-v2-permission-decision",
  n8nG8BrandSafetyCheckPath: process.env.N8N_G8_BRAND_SAFETY_CHECK_PATH || "g8-v2-brand-safety-check",
  n8nG8DisclosureCheckPath: process.env.N8N_G8_DISCLOSURE_CHECK_PATH || "g8-v2-disclosure-check",
  n8nG8CreateApprovedAssetPath: process.env.N8N_G8_CREATE_APPROVED_ASSET_PATH || "g8-v2-create-approved-asset",
  n8nG8PermissionRevokePath: process.env.N8N_G8_PERMISSION_REVOKE_PATH || "g8-v2-permission-revoke",
  n8nG8CreatorTrackingRegisterPath: process.env.N8N_G8_CREATOR_TRACKING_REGISTER_PATH || "g8-v2-creator-tracking-register",
  ...
  metaAccessToken: process.env.META_ACCESS_TOKEN || process.env.WHATSAPP_ACCESS_TOKEN || "",
  metaInstagramAccountId: process.env.META_INSTAGRAM_ACCOUNT_ID || process.env.INSTAGRAM_ACCOUNT_ID || "",
  metaBusinessAccountId: process.env.META_BUSINESS_ACCOUNT_ID || process.env.META_BUSINESS_ID || "",
  metaAdAccountId: process.env.META_AD_ACCOUNT_ID || "",
  whatsappAccessToken: process.env.WHATSAPP_ACCESS_TOKEN || process.env.META_ACCESS_TOKEN || "",
  whatsappPhoneNumberId: process.env.WHATSAPP_PHONE_NUMBER_ID || process.env.META_PHONE_NUMBER_ID || "",
  whatsappBusinessAccountId: process.env.WHATSAPP_BUSINESS_ACCOUNT_ID || process.env.META_BUSINESS_ACCOUNT_ID || process.env.META_BUSINESS_ID || "",
