...
export const env = Object.freeze({
  ...
  n8nG7StockDiscountValidatePath: process.env.N8N_G7_STOCK_DISCOUNT_VALIDATE_PATH || "g7-stock-discount-validate",
  n8nG7StockDiscountValidateUrl: resolveWebhookUrl(
    process.env.N8N_G7_STOCK_DISCOUNT_VALIDATE_URL,
    process.env.N8N_G7_STOCK_DISCOUNT_VALIDATE_PATH || "g7-stock-discount-validate",
  ),
  n8nG7ProofExpirePath: process.env.N8N_G7_PROOF_EXPIRE_PATH || "g7-proof-expire",
  n8nG7ProofExpireUrl: resolveWebhookUrl(process.env.N8N_G7_PROOF_EXPIRE_URL, process.env.N8N_G7_PROOF_EXPIRE_PATH || "g7-proof-expire"),
