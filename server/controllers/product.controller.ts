...
const collectGalleryUrls = (raw: Record<string, any> = {}) => {
...
const normalizeImagesInput = (raw: Record<string, any> = {}) => {
...
const normalizeShadesInput = (shades: any[] | undefined) => {
...
const normalizeExperiencePayload = (raw: Record<string, any> = {}) => {
  const experience: Record<string, any> = { ...(raw.experience ?? {}) };
...
const normalizeProductInput = (raw: Record<string, any> = {}, { allowDefaults = true, deriveSlug = true } = {}) => {
...
const parseProductInput = (raw: Record<string, any>, { partial = false } = {}) => {
