...
> = {
  ...
  G5: {
    ...
    pendingApprovalsCount: 1,
    latestFailureReason: "A pending asset is waiting for approval before manual publishing.",
...
const createInitialApprovals = (): CevonneApprovalRecord[] => [
  {
    ...
    workflowGroup: "G5",
    workflowName: "Asset Approval + Manual Publishing Queue",
    ...
    status: "PENDING",
    reviewerAction: null,
    summary: "Review the spring launch asset before manual publishing.",
    approvalNotes: "Spring launch asset is ready for human approval. Dry-run and manual publish proof stay blocked until approval is recorded.",
    requireConfirmation: true,
    assetSnapshot: {
      assetId: "spring-launch-batch-01",
      platform: "INSTAGRAM",
      headline: "Spring launch asset queue",
      caption: "Spring launch is ready for manual publishing after review.",
      content: "Fresh seasonal launch copy, approved visuals, and manual publish proof are prepared for the queue.",
